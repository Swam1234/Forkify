...
class AddBookmarkView extends View {
 ...
 _renderForm() {
  ...
  <label>Title</label>
  <input value="TEST45" required name="title" type="text" />
  <label>URL</label>
  <input value="TEST45" required name="sourceUrl" type="text" />
  <label>Image URL</label>
  <input value="TEST45" required name="image" type="text" />
  <label>Publisher</label>
  <input value="TEST45" required name="publisher" type="text" />
